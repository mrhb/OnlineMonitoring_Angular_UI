...
export class DataService implements InMemoryDbService {
  createDb() {
    ...
    const users: User[] = [
      {id:1,unitCount: 1, firstName: 'M.Reza', email:'mmhajjar82@gmail.com' ,lastName:'mrhb',    lang:'En',conn:1,reportsM:true,reportsW:true,api:true,isadmin:true },
      {id:2,unitCount: 2, firstName: 'Hajjar.B'  ,email:'sdf_435@hotmail.com'  ,lastName:'masdfrhb',lang:'En',conn:1,reportsM:false,reportsW:false,api:true,isadmin:false},
      {id:3,unitCount: 3, firstName: 'mrhb' ,email:'dfsced_def@yahoo.com' ,lastName:'mdfrhb',  lang:'En',conn:1,reportsM:true,reportsW:true,api:true,isadmin:false},      
    ];
